...
QT_MOC_LITERAL(1, 12, 11), // "serial_read"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 12) // "serial_write"

    },
    "Serial_port\0serial_read\0\0serial_write"
};
...
void Serial_port::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { QString _r = _t->serial_read();
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = _r; }  break;
        case 1: _t->serial_write((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject Serial_port::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Serial_port.data,
