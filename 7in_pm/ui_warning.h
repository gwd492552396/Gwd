...
public:
    ...
    void setupUi(QWidget *Warning)
    {
        ...
        Warning->resize(1154, 688);
        Warning->setMinimumSize(QSize(674, 400));
        Warning->setStyleSheet(QStringLiteral("background:transparent;"));
        verticalLayout = new QVBoxLayout(Warning);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        qTableWidget = new QTableWidget(Warning);
        qTableWidget->setObjectName(QStringLiteral("qTableWidget"));
        qTableWidget->setStyleSheet(QStringLiteral(""));
        ...
        horizontalLayout_2->setContentsMargins(9, 0, 0, -1);
        horizontalSpacer = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        horizontalLayout_2->addItem(horizontalSpacer);

        btn_previous = new QPushButton(Warning);
...
""));
        ...
        page_number = new QLabel(Warning);
...
"color: #FFFFFF;"));
        ...
        btn_next = new QPushButton(Warning);
...
"color: #FFFFFF;"));
        ...
        btn_back = new QPushButton(Warning);
...
""));
    ...
    void retranslateUi(QWidget *Warning)
    {
        ...
        page_number->setText(QApplication::translate("Warning", "0/1", 0));
        btn_next->setText(QString());
        sign->setText(QApplication::translate("Warning", "\346\212\245\350\255\246\344\277\241\346\201\257\346\237\245\350\257\242", 0));
