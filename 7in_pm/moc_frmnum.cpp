...
QT_MOC_LITERAL(4, 19, 12), // "focusChanged"
QT_MOC_LITERAL(5, 32, 8), // "QWidget*"
QT_MOC_LITERAL(6, 41, 9), // "oldWidget"
QT_MOC_LITERAL(7, 51, 9), // "nowWidget"
QT_MOC_LITERAL(8, 61, 11), // "btn_clicked"
QT_MOC_LITERAL(9, 73, 9) // "reClicked"

    },
    "frmNum\0change\0\0log\0focusChanged\0"
    "QWidget*\0oldWidget\0nowWidget\0btn_clicked\0"
    "reClicked"
};
...
void frmNum::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->focusChanged((*reinterpret_cast< QWidget*(*)>(_a[1])),(*reinterpret_cast< QWidget*(*)>(_a[2]))); break;
        case 3: _t->btn_clicked(); break;
        ...
        {
            typedef void (frmNum::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&frmNum::change)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (frmNum::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&frmNum::log)) {
                *result = 1;
                return;
            }
        }
