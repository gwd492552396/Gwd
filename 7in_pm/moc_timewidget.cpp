...
QT_MOC_LITERAL(3, 21, 16) // "on_close_clicked"
    ...
    "timewidget\0senddata\0\0on_close_clicked"
};
...
void timewidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (timewidget::*_t)(QString , QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&timewidget::senddata)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void timewidget::senddata(QString _t1, QString _t2)
{
