...
QT_MOC_LITERAL(1, 6, 9), // "back_home"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 8), // "previous"
QT_MOC_LITERAL(4, 26, 3), // "log"
QT_MOC_LITERAL(5, 30, 12) // "ReceiveImage"

    },
    "Video\0back_home\0\0previous\0log\0"
    "ReceiveImage"
};
...
void Video::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->ReceiveImage((*reinterpret_cast< QImage(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Video::back_home)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Video::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Video::previous)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (Video::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Video::log)) {
                *result = 2;
                return;
            }
        }
