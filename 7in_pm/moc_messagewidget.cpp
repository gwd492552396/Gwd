...
QT_MOC_LITERAL(1, 14, 13), // "message_close"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 16) // "on_close_clicked"

    },
    "MessageWidget\0message_close\0\0"
    "on_close_clicked"
};
...
void MessageWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (MessageWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MessageWidget::message_close)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MessageWidget::message_close()
{
