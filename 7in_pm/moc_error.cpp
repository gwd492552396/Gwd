...
QT_MOC_LITERAL(3, 16, 9), // "next_page"
QT_MOC_LITERAL(4, 26, 13), // "previous_page"
QT_MOC_LITERAL(5, 40, 19), // "on_btn_back_clicked"
QT_MOC_LITERAL(6, 60, 12), // "update_table"
QT_MOC_LITERAL(7, 73, 10), // "error_time"
QT_MOC_LITERAL(8, 84, 10), // "error_type"
QT_MOC_LITERAL(9, 95, 10), // "error_name"
QT_MOC_LITERAL(10, 106, 10), // "delete_row"
QT_MOC_LITERAL(11, 117, 3) // "key"

    },
    "Error\0previous\0\0next_page\0previous_page\0"
    "on_btn_back_clicked\0update_table\0"
    "error_time\0error_type\0error_name\0"
    "delete_row\0key"
};
...
void Error::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Error::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Error::previous)) {
                *result = 0;
                return;
            }
        }
