/********************************************************************************
** Form generated from reading UI file 'isgpower.ui'
**
...
#ifndef UI_ISGPOWER_H
#define UI_ISGPOWER_H
...
public:
    ...
    void setupUi(QWidget *IsgPower)
    {
        if (IsgPower->objectName().isEmpty())
            IsgPower->setObjectName(QStringLiteral("IsgPower"));
        IsgPower->resize(1080, 652);
        IsgPower->setMinimumSize(QSize(1080, 652));
        IsgPower->setMaximumSize(QSize(1302, 652));
        IsgPower->setStyleSheet(QLatin1String("background:transparent;\n"
""));
        gridLayout = new QGridLayout(IsgPower);
        gridLayout->setObjectName(QStringLiteral("gridLayout"));
        gridLayout->setContentsMargins(20, -1, -1, -1);
        widget_5 = new QWidget(IsgPower);
        ...
        isg_control_temp = new QLabel(widget_5);
        isg_control_temp->setObjectName(QStringLiteral("isg_control_temp"));
        isg_control_temp->setStyleSheet(QLatin1String("font: 75 9pt \"Microsoft YaHei UI\";\n"
"font-size: 60px;\n"
"color: #FFFFFF;\n"
"background:transparent;"));
        isg_control_temp->setAlignment(Qt::AlignCenter);

        verticalLayout_10->addWidget(isg_control_temp);
...
"color: #FFFFFF;"));
        ...
        btn_back = new QPushButton(IsgPower);
...
"background-color: rgb(0, 0, 0);"));
        ...
        retranslateUi(IsgPower);

        QMetaObject::connectSlotsByName(IsgPower);
    } // setupUi

    void retranslateUi(QWidget *IsgPower)
    {
        IsgPower->setWindowTitle(QApplication::translate("IsgPower", "Form", 0));
        isg_control_temp->setText(QApplication::translate("IsgPower", "0000", 0));
        label_16->setText(QApplication::translate("IsgPower", "ISG\347\224\265\346\234\272\346\216\247\345\210\266\n"
"\346\270\251\345\272\246(\346\221\204\346\260\217\345\272\246)", 0));
        direct_current->setText(QApplication::translate("IsgPower", "0000", 0));
        label_12->setText(QApplication::translate("IsgPower", "\347\233\264\346\265\201\347\224\265\346\265\201(A)", 0));
        sign->setText(QApplication::translate("IsgPower", "ISG\347\224\265\346\234\272", 0));
        btn_back->setText(QString());
        driver_temper->setText(QApplication::translate("IsgPower", "0000", 0));
        label_17->setText(QApplication::translate("IsgPower", "\351\251\261\345\212\250\347\224\265\346\234\272\346\270\251\n"
"\345\272\246(\346\221\204\346\260\217\345\272\246)", 0));
        real_rev->setText(QApplication::translate("IsgPower", "0000", 0));
        label_13->setText(QApplication::translate("IsgPower", "\345\256\236\351\231\205\350\275\254\351\200\237(rpm)", 0));
        real_torque->setText(QApplication::translate("IsgPower", "0000", 0));
        label_14->setText(QApplication::translate("IsgPower", "\345\256\236\351\231\205\350\275\254\347\237\251(Nm)", 0));
        emc_input_v->setText(QApplication::translate("IsgPower", "0000", 0));
        label_15->setText(QApplication::translate("IsgPower", "\347\224\265\346\234\272\346\216\247\345\210\266\345\231\250\n"
"\350\276\223\345\205\245\347\224\265\345\216\213(V)", 0));
        Label->setText(QApplication::translate("IsgPower", "\345\267\245\344\275\234\346\250\241\345\274\217", 0));
        work_mode->setText(QApplication::translate("IsgPower", "TextLabel", 0));
        Label2->setText(QApplication::translate("IsgPower", "\350\277\220\350\241\214\347\212\266\346\200\201", 0));
        running_state->setText(QApplication::translate("IsgPower", "TextLabel", 0));
        Label3->setText(QApplication::translate("IsgPower", "\346\225\205\351\232\234\347\212\266\346\200\201", 0));
        falut_state->setText(QApplication::translate("IsgPower", "TextLabel", 0));
        Label4->setText(QApplication::translate("IsgPower", "\347\224\265\346\234\272\350\275\254\345\220\221", 0));
        em_direction->setText(QApplication::translate("IsgPower", "TextLabel", 0));
    } // retranslateUi

};

namespace Ui {
    class IsgPower: public Ui_IsgPower {};
} // namespace Ui
