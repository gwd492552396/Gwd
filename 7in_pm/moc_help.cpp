...
QT_MOC_LITERAL(1, 5, 18), // "edit_shortcut_save"
QT_MOC_LITERAL(2, 24, 0) // ""

    },
    "Help\0edit_shortcut_save\0"
};
...
void Help::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->edit_shortcut_save((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3])),(*reinterpret_cast< int(*)>(_a[4]))); break;
        default: ;
        }
    }
}
