...
public:
    ...
    void setupUi(QWidget *Help)
    {
        ...
        Help->resize(1080, 652);
        Help->setMinimumSize(QSize(674, 400));
        Help->setStyleSheet(QLatin1String("background:transparent;\n"
"border:none;"));
...
"border:none;"));
        ...
        l_1 = new QLabel(widget);
        l_1->setObjectName(QStringLiteral("l_1"));
...
""));
        ...
        verticalLayout->addWidget(l_2);

        verticalSpacer_3 = new QSpacerItem(20, 40, QSizePolicy::Minimum, QSizePolicy::Expanding);

        verticalLayout->addItem(verticalSpacer_3);

        l_3 = new QLabel(widget);
...
""));
        ...
        verticalLayout->addWidget(l_3);

        verticalSpacer_4 = new QSpacerItem(20, 40, QSizePolicy::Minimum, QSizePolicy::Expanding);

        verticalLayout->addItem(verticalSpacer_4);

        l_4 = new QLabel(widget);
        l_4->setObjectName(QStringLiteral("l_4"));
...
""));
        ...
        verticalLayout_2->addWidget(r_1);
...
""));
        ...
        verticalLayout_2->addWidget(r_2);
...
""));
        ...
        verticalLayout_2->addWidget(r_3);

        verticalSpacer_9 = new QSpacerItem(20, 40, QSizePolicy::Minimum, QSizePolicy::Expanding);

        verticalLayout_2->addItem(verticalSpacer_9);

        r_4 = new QLabel(widget_2);
...
""));
    ...
    void retranslateUi(QWidget *Help)
    {
        ...
        l_1->setText(QApplication::translate("Help", "\347\216\257\350\275\246\345\275\261\345\203\217", 0));
