...
QT_MOC_LITERAL(3, 14, 9), // "SendImage"
QT_MOC_LITERAL(4, 24, 13) // "receiver_stop"

    },
    "receiver\0log\0\0SendImage\0receiver_stop"
};
...
void receiver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&receiver::log)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (receiver::*_t)(QImage );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&receiver::SendImage)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&receiver::receiver_stop)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 1
void receiver::SendImage(QImage _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
