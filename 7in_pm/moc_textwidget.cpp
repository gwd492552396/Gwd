...
QT_MOC_LITERAL(4, 38, 7) // "receive"

    },
    "TextWidget\0senddata\0\0on_close_clicked\0"
    "receive"
};
...
void TextWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->receive((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (TextWidget::*_t)(QString , QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TextWidget::senddata)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TextWidget::senddata(QString _t1, QString _t2)
{
